    ...
    <div className={`${detailsStyles.wrapper} ${isNotModal && "mt-30"}`}>
      ...
      <ul className={`${detailsStyles.value} list-default`}>
        <li className={detailsStyles.value__item}>
          ...
          <p data-testid='ingredient__cal' className="text text_type_digits-default text_color_inactive">{ingredientData?.calories}</p>
        </li>
        <li className={detailsStyles.value__item}>
          <h4 className="text text_type_main-default text_color_inactive">Белки, г</h4>
          <p data-testid='ingredient__protein' className="text text_type_digits-default text_color_inactive">{ingredientData?.proteins}</p>
        </li>
        <li className={detailsStyles.value__item}>
          <h4 className="text text_type_main-default text_color_inactive">Жиры, г</h4>
          <p data-testid='ingredient__fat' className="text text_type_digits-default text_color_inactive">{ingredientData?.fat}</p>
        </li>
        <li className={detailsStyles.value__item}>
          <h4 className="text text_type_main-default text_color_inactive">Углеводы, г</h4>
          <p data-testid='ingredient__carb' className="text text_type_digits-default text_color_inactive">{ingredientData?.carbohydrates}</p>
        </li>
      </ul>
    </div>
  )
